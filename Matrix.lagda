...
%
We use a datatype |M| with four constructors: |One|, |Row|, |Col|, and
|Q|.
%
...
either 1-by-1 matrices or further row or column matrices
...
This matrix representation allows us to lift a semi-ring to a
...
transpose (Q m₁₁ m₁₂ m₂₁ m₂₂)  = Q    (transpose m₁₁)  (transpose m₂₁)
